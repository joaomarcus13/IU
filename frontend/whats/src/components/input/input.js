...
function Input(props) {
    ...
    function toggleIcon() {
        document.querySelectorAll('.search-aside-icon').forEach(e => { e.style.display = 'none' })
        document.querySelectorAll('.search-aside-back').forEach(e => { e.style.display = 'block' })
    ...
    return (
        ...
        <div className='search-aside'>
            ...
            <input type='text' onFocus={toggleIcon} id='input-aside' placeholder={props.placeholder}>

...
function Main() {
    return (
        ...
        <div className ='message-l'>
          ...
          <div className = 'msg-l'> mensagembgbmgklbmhkmbnjknkjnjbrjnjknkjn </div>
          <div className='hora'> 10:32 </div>
        </div>

        <svg xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" viewBox="0 0 53 53" width="53" height="53">
                <defs>
